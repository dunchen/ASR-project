...
{ 
	...
	GPIO_SetBits(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0800)), ((u16)0x0010));
...
void SPI_SendByte(INT8U byte)
{
  ...
  SPI_I2S_SendData(((SPI_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3000)), byte);
}
...
INT8U SPI_RecByte(void)
{
  ...
  SPI_I2S_SendData(((SPI_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3000)), 0xFF);

   
  while (SPI_I2S_GetFlagStatus(((SPI_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3000)), ((u16)0x0001)) == RESET);
   
  Data = SPI_I2S_ReceiveData(((SPI_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3000)));
...
{
	GPIO_ResetBits(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0800)), ((u16)0x0010));			   					   
}
...
void SPI_Config(void)
{
  ...
  RCC_APB2PeriphClockCmd(((u32)0x00000004) | ((u32)0x00000010) |((u32)0x00000040), ENABLE);
