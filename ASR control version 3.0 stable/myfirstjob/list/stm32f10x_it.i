#line 1 "interrupt\\stm32f10x_it.c"
...
#line 1 "interrupt\\stm32f10x_it.h"
...
#line 22 "interrupt\\stm32f10x_it.h"
...
#line 23 "interrupt\\stm32f10x_it.h"
...
#line 20 "interrupt\\stm32f10x_it.c"
...
u8 RxGPSBuffer[5][210];
u8 RxGPSLength[5];
int GPSCachCounter=0;
int GPSRxCounter=0;



u8 RxSensorBuffer[5][100];
u8 SensorDataLength[5];
int SensorCachCounter=0;
int SensorRxCounter=0;

int GPSTransCach=0;
int SensorTransCach=0;
int SensorRecordCach=0;
...
void EXTI0_IRQHandler(void)
{
	...
	while (!(((GPSTransCach+1) % 5)==GPSCachCounter))
	{
		for (i=0;i<RxGPSLength[GPSTransCach];i++)
		{
			USART_SendData(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)), RxGPSBuffer[GPSTransCach][i]); 
	    while(USART_GetFlagStatus(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)), ((u16)0x0080)) == RESET);
		}
		GPSTransCach=(GPSTransCach+1) % 5;
	}
	EXTI_ClearFlag(((u32)0x00001));
}
...
{
	int i;
	while (!(((SensorTransCach+1) % 5)==SensorCachCounter))
	{
		
		for (i=0;i<SensorDataLength[SensorTransCach];i++)
		{
			USART_SendData(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)), RxSensorBuffer[SensorTransCach][i]); 
	    while(USART_GetFlagStatus(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)), ((u16)0x0080)) == RESET);
		}
		SensorTransCach=(SensorTransCach+1) % 5;
	}
	EXTI_ClearFlag(((u32)0x00002));
}
...
void EXTI2_IRQHandler(void)
{
	...
	while (!(((SensorRecordCach+1) % 5)==SensorCachCounter))
	{
		SensorRecordCach=(SensorRecordCach+1) % 5;
	  for (i=0;i<SensorDataLength[SensorRecordCach];i++)
		{
		  SDcounter++;
			sd_send_buf[SDcounter]=RxSensorBuffer[SensorRecordCach][i];
	    if (SDcounter==512) 
	  	{
	  		t = MSD_WriteBlock(sd_send_buf,SD_BLOCK,512);
	  		SD_BLOCK++;
	  		SDcounter=0;
	  	}
		}
	}
	EXTI_ClearFlag(((u32)0x00004));
...
void TIM2_IRQHandler(void)
{
	if(TIM_GetITStatus(((TIM_TypeDef *) (((u32)0x40000000) + 0x0000)), ((u16)0x0001)) == SET)
      {
...
void USART1_IRQHandler(void)
{
	...
	if(USART_GetFlagStatus(((USART_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3800)), ((u16)0x0020)) == SET)
 {
    ...
    tt = (USART_ReceiveData(((USART_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3800))));
	  RxGPSBuffer[GPSCachCounter][GPSRxCounter] = tt;
    GPSRxCounter++;
	  USART_ClearITPendingBit(((USART_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x3800)), ((u16)0x0525));
	  if(tt== '$')
    {
			RxGPSLength[GPSCachCounter]= GPSRxCounter-1;
			GPSRxCounter=1;
			GPSCachCounter=(GPSCachCounter+1) % 5;
			RxGPSBuffer[GPSCachCounter][0]= 36;
...
{
	char tt;
	if(USART_GetFlagStatus(((USART_TypeDef *) (((u32)0x40000000) + 0x4400)), ((u16)0x0020)) != RESET)
 {
     
    tt= (USART_ReceiveData(((USART_TypeDef *) (((u32)0x40000000) + 0x4400))));
	  RxSensorBuffer[SensorCachCounter][SensorRxCounter] =tt;
	  SensorRxCounter++;
    USART_ClearITPendingBit(((USART_TypeDef *) (((u32)0x40000000) + 0x4400)), ((u16)0x0525));
	  if(tt=='*')
    {
			SensorDataLength[SensorCachCounter]= SensorRxCounter-1;
      SensorRxCounter=1;
			SensorCachCounter=(SensorCachCounter+1) % 5;
			RxSensorBuffer[SensorCachCounter][0]='&';
			EXTI_GenerateSWInterrupt(((u32)0x00004));   
