#line 1 "library\\src\\stm32f10x_rcc.c"
...
#line 18 "library\\src\\stm32f10x_rcc.c"
...
#line 83 "library\\src\\stm32f10x_rcc.c"
...
ErrorStatus RCC_WaitForHSEStartUp(void)
{
  ...
  do
  {
    ...
    StartUpCounter++;  
  } while((HSEStatus == RESET) && (StartUpCounter != ((u16)0x0500)));
