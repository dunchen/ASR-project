...
extern u8 RxGPSBuffer[5][12];
extern int GPSCachCounter;
extern int GPSRxCounter;



extern u8 RxSensorBuffer[5][12];
...
void NVIC_Configuration(void)
{
	...
	NVIC_PriorityGroupConfig(((u32)0x400));
	...
	NVIC_InitStructure.NVIC_IRQChannel =((u8)0x25);
	...
	NVIC_InitStructure.NVIC_IRQChannel =((u8)0x26);
	NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority =1;
	NVIC_InitStructure.NVIC_IRQChannelSubPriority = 0;
	NVIC_InitStructure.NVIC_IRQChannelCmd =ENABLE;
	NVIC_Init(&NVIC_InitStructure);
  ...
  NVIC_Init(&NVIC_InitStructure);
	...
	NVIC_InitStructure.NVIC_IRQChannel = ((u8)0x08);
...
void EXTI_cfg()
{
       ...
       GPIO_EXTILineConfig(((u8)0x02), ((u8)0x01));
       GPIO_EXTILineConfig(((u8)0x02), ((u8)0x02));
       GPIO_EXTILineConfig(((u8)0x02), ((u8)0x03));
 
       EXTI_InitStructure.EXTI_Line = ((u32)0x00001) | ((u32)0x00002) | ((u32)0x00004);
...
int main(void)
{
  ...
  int i;
	...
	ret = MSD_Init();
	USART_SendData(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)), ret); 
	while(USART_GetFlagStatus(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)), ((u16)0x0080)) == RESET);
	USART_SendData(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)), '*'); 
	while(USART_GetFlagStatus(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)), ((u16)0x0080)) == RESET);
	ret = MSD_GetMediumCharacteristics();
	USART_SendData(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)), Mass_Block_Count); 
	while(USART_GetFlagStatus(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)), ((u16)0x0080)) == RESET);
	USART_SendData(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)), '*'); 
	while(USART_GetFlagStatus(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)), ((u16)0x0080)) == RESET);
	USART_SendData(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)), Mass_Block_Size); 
	while(USART_GetFlagStatus(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)), ((u16)0x0080)) == RESET);
	USART_SendData(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)), '*'); 
	while(USART_GetFlagStatus(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)), ((u16)0x0080)) == RESET);
	USART_SendData(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)), Mass_Memory_Size); 
	while(USART_GetFlagStatus(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)), ((u16)0x0080)) == RESET);
	...
	while (Timedisplay<10)
	{
	  ...
	  if ((USART_GetFlagStatus(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)), ((u16)0x0020)) == SET)
			   && (USART_ReceiveData(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)))==66)) 
		  {
  ...
  Timedisplay=0;
	...
	while ((Timedisplay<60*5) &&
		     (!((USART_GetFlagStatus(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)), ((u16)0x0020)) == SET)
			      && (USART_ReceiveData(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)))==71))))  
	{
	...
	while ((Timedisplay<20) &&
		     (!((USART_GetFlagStatus(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)), ((u16)0x0020)) == SET)
			      && (USART_ReceiveData(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)))==69))));  
	...
	while (!((USART_GetFlagStatus(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)), ((u16)0x0020)) == SET)
			      && (USART_ReceiveData(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)))==76))); 
  ...
  USART_ITConfig(((USART_TypeDef *) (((u32)0x40000000) + 0x4400)), ((u16)0x0525), ENABLE);
	...
	while(1)
	{
	    ...
	    for (i=0;i<strlen(Responce6);i++)
	    	{
	     		USART_SendData(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)), Responce6[i]); 
	        while(USART_GetFlagStatus(((USART_TypeDef *) (((u32)0x40000000) + 0x4800)), ((u16)0x0080)) == RESET);
		    }
		}
	}
