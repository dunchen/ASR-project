...
extern FLASH_Status FLASH_ErasePage(u32 Page_Address);
extern FLASH_Status FLASH_EraseAllPages(void);
extern FLASH_Status FLASH_EraseOptionBytes(void);
extern FLASH_Status FLASH_ProgramWord(u32 Address, u32 Data);
extern FLASH_Status FLASH_ProgramHalfWord(u32 Address, u16 Data);
