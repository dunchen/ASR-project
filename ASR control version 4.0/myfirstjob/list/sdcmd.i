...
INT8U SD_SendCmd(INT8U cmd, INT8U *param, INT8U resptype, INT8U *resp)
{
    ...
    {												   
        tmp = SPI_RecByte();
        i++;
    }while (((tmp & 0x80) != 0) && (tmp!=0xE5) && (i < 100));
